...
function createNuxtApp(options) {
  ...
  const nuxtApp = {
    ...
    versions: {
      get nuxt() {
        return "3.6.5-28163044.380a9198";
      },
      get vue() {
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c3b5d155"]]);
const _sfc_main$2 = {};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-a8f489e4.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-f2715e45.mjs').then((r) => r.default || r));
