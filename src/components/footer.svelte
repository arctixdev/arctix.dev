...
>
	<div class="items-center grid-flow-col">
		<svg
			...
			fill-rule="evenodd"
			clip-rule="evenodd"
			class="fill-current hidden sm:block"
			><path
		...
		<p class="font-bold text-xs sm:text-base">
			Copyright Jonathan Bangert© 2022 - All right reserved
		</p>
	</div>
	<div class="grid-flow-col gap-4 md:place-self-center md:justify-self-end hidden sm:grid">
