    ...
    <div>
        ...
        <div class="showcase h-fit">
            ...
            <div class="flex overflow-hidden justify-between h-fit">
                ...
                <img format="avif,webp" class="rounded-lg hidden-mobile-inline showcase-pic" src="/mass.webp" alt="Music Assistant layout" />
            </div>
            <img format="avif,webp" src="/mass.webp" alt="Music Assistant layout" class="rounded-lg only-mobile showcase-pic"/>
        </div>
    </div>
</template>
